...
QUICKSTART_IPYNB = "quickstart_segmentation.ipynb"
QUICKSTART_PY = "quickstart_segmentation.py"


def test_that_the_quickstart_notebook_does_not_crash():
    os.chdir(THIS_DIR)
    return_value = os.system("poetry run python quickstart_segmentation.py")
